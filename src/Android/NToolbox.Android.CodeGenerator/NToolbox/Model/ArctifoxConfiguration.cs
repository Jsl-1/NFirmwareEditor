...
namespace NToolbox.Models
{
	...
	public partial class ArcticFoxConfiguration
	{
		...
		public enum ChargeScreenType : byte
		{
			Classic = 0,
			Extended = 1
		}
		...
		public enum PuffsTimeFormat : byte
		{
			Seconds = 0,
			HourMinuteSeconds = 1
		}
		...
		public enum ScreenProtectionTime : byte
		{
			Off = 0,
			Min1 = 1,
			Min2 = 2,
		...
		public class ClassicLinesContent
		{
		...
		public class CircleLinesContent
		{
		...
		public class SmallLinesContent
		{
